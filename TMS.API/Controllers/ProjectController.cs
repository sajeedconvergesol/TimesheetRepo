...
namespace TMS.API.Controllers
{
    ...
    public class ProjectController : ControllerBase
    {
        ...
        public ProjectController(IProjectService projectService, ILogger<ProjectController> logger, Mapper mapper, IProjectDocumentService projectDocumentService, IConfiguration configuration)
        {
            _mapper = mapper;
